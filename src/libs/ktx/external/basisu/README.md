This is a stripped down version of Basis Universal.
It's based on the one used by libktx (https://github.com/KhronosGroup/KTX-Software)
as of commit 6163359 "Stop Xcode compressing .dae files."
It is stripped down further to just contain what's needed for libktx_read, i.e. for reading
.ktx2 files with basis universal data, not for writing. Just the transcoder, not the encoder.
